          ...
          <div className="space-y-8">
            <div className="space-y-4">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                Descubra veículos de qualidade premium com preços imbatíveis. Desde sedans de luxo a SUVs fiáveis, temos
                o carro perfeito à sua espera.
              </p>
            </div>

            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="text-lg px-8 bg-[#1e3a5f] hover:bg-[#2c4f7a]">
                Ver Inventário
            ...
            <div className="grid grid-cols-3 gap-8 pt-8 border-t">
              <div className="text-center">
                <div className="text-3xl font-bold text-[#1e3a5f]">Vários</div>
                <div className="text-sm text-gray-600">Carros Disponíveis</div>
              </div>
              <div className="text-center">
